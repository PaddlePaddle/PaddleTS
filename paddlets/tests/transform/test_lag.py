...
class TestLagFeature(TestCase):
    ...
    def test_transform(self):
        ...
        known_true_df = pd.DataFrame({
            ...
            'load_before_2': [np.nan, np.nan, 1., 2., 3.],
            'load_before_4': [np.nan, np.nan, np.nan, np.nan, 1.]
        }).set_index('DATE_TIME')
        ...
        known_true_df = pd.DataFrame({
            ...
            'other_before_2': [np.nan, np.nan, 1., 2., 3.],
            'other_before_4': [np.nan, np.nan, np.nan, np.nan, 1.]
        }).set_index('DATE_TIME')
