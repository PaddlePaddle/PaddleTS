...
class TestNLinearModel(TestCase):
    def setUp(self):
        ...
        self.data_single_target = TSDataset(
            target_single, observed_cov, known_cov, static_cov
        )
        self.data_multi_target = TSDataset(
            target_multi, observed_cov, known_cov, static_cov
        )
        self.data_no_cov = TSDataset(target_single, None, None, None)
        self.data_int_type = TSDataset(int_target, None, category_known_cov, None)
