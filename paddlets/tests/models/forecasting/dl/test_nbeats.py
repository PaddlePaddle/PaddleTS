...
class TestTrendBlock(TestCase):
    def setUp(self):
        ...
        self.data_input = [
            ...
            paddle.randn([64, 96 * 7 + 9 * 4, 2]), paddle.randn([64, 96, 2])
        ]
...
class TestNBeatsModel(TestCase):
    def setUp(self):
        ...
        self.tsdataset1 = TSDataset(target_single, observed_cov, known_cov,
                                    static_cov)
        self.tsdataset2 = TSDataset(target_multi, observed_cov, known_cov,
                                    static_cov)
