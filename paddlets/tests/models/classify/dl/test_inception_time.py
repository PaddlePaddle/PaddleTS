...
class TestInceptionTimeClassifier(TestCase):
    def setUp(self):
        ...
        """
        np.random.seed(2022)
        paddlets_ds, labels = self._build_mock_data_and_label(
            range_index=True, instance_cnt=10, target_dims=1)
        paddlets_ds2, labels2 = self._build_mock_data_and_label(
            range_index=False, instance_cnt=10, target_dims=2)
    ...
    def test_init(self):
        ...
        #case2
        self.model2 = InceptionTimeClassifier(max_epochs=10, batch_size=16)
        ...
        self.model4 = InceptionTimeClassifier(
            max_epochs=10, batch_size=16, block_depth=8, kernel_size=80)

        #case5
        self.model5 = InceptionTimeClassifier(
            max_epochs=10, batch_size=16, activation="Sigmoid")
