...
class TestAutoEncoder(TestCase):
    ...
    def test_init(self):
        ...
        ae = AutoEncoder(in_chunk_len=16, **param1)
        ...
        with self.assertRaises(ValueError):
            ae = AutoEncoder(in_chunk_len=16, **param2)
        ...
        with self.assertRaises(ValueError):
            ae = AutoEncoder(in_chunk_len=16, **param3)
        ...
        with self.assertRaises(ValueError):
            ae = AutoEncoder(in_chunk_len=16, **param4)
        ...
        with self.assertRaises(ValueError):
            ae = AutoEncoder(in_chunk_len=16, **param5)
        ...
        with self.assertRaises(ValueError):
            ae = AutoEncoder(in_chunk_len=16, **param6)
        ...
        ae = AutoEncoder(in_chunk_len=16, **param7)
        ae.fit(self.tsdataset1)
        self.assertIsInstance(ae._network._encoder._nn[1],
                              paddle.nn.BatchNorm1D)

    def test_init_dataloader(self):
        """unittest function for init dataloader
        """
        ae = AutoEncoder(in_chunk_len=16, max_epochs=1)
    ...
    def test_init_metrics(self):
        ...
        ae = AutoEncoder(in_chunk_len=16, max_epochs=1, eval_metrics=["mae"])
    ...
    def test_init_callbacks(self):
        ...
        """
        # case1 (patience = 0)
        ae = AutoEncoder(in_chunk_len=16, patience=0)
        ...
        # case2 (patience > 0)
        ae = AutoEncoder(in_chunk_len=16, patience=1)
        ae._metrics, ae._metrics_names, _ = ae._init_metrics(["val"])
        ...
        callback = Callback()
        ae = AutoEncoder(in_chunk_len=16, callbacks=[callback])
        ae._metrics, ae._metrics_names, _ = ae._init_metrics(["val"])
        _, callback_container = ae._init_callbacks()
