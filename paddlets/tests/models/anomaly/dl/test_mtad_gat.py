...
class TestMTADGAT(TestCase):
    ...
    def test_init(self):
        ...
        mtad_gat = MTADGAT(in_chunk_len=16, **param1)
        ...
        with self.assertRaises(ValueError):
            mtad_gat = MTADGAT(in_chunk_len=16, **param2)
        ...
        with self.assertRaises(ValueError):
            mtad_gat = MTADGAT(in_chunk_len=16, **param3)
        ...
        with self.assertRaises(ValueError):
            mtad_gat = MTADGAT(in_chunk_len=16, **param4)
        ...
        with self.assertRaises(ValueError):
            mtad_gat = MTADGAT(in_chunk_len=16, **param5)
        ...
        with self.assertRaises(ValueError):
            mtad_gat = MTADGAT(in_chunk_len=16, **param6)
    ...
    def test_init_dataloader(self):
        ...
        """
        mtad_gat = MTADGAT(in_chunk_len=16, max_epochs=1)
    ...
    def test_init_callbacks(self):
        ...
        """
        # case1 (patience = 0)
        mtad_gat = MTADGAT(in_chunk_len=16, patience=0)
        mtad_gat._metrics, mtad_gat._metrics_names, _ = mtad_gat._init_metrics(
            ["val"])
        ...
        # case2 (patience > 0)
        mtad_gat = MTADGAT(in_chunk_len=16, patience=1)
        mtad_gat._metrics, mtad_gat._metrics_names, _ = mtad_gat._init_metrics(
            ["val"])
        ...
        callback = Callback()
        mtad_gat = MTADGAT(in_chunk_len=16, callbacks=[callback])
        mtad_gat._metrics, mtad_gat._metrics_names, _ = mtad_gat._init_metrics(
            ["val"])
        _, callback_container = mtad_gat._init_callbacks()
    ...
    def test_predict(self):
        ...
        mtad_gat = MTADGAT(in_chunk_len=16, max_epochs=1, patience=1)
        ...
        mtad_gat = MTADGAT(in_chunk_len=32, max_epochs=1, patience=1)
