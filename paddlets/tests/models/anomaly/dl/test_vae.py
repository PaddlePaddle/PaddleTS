...
class TestVAE(TestCase):
    ...
    def test_init(self):
        ...
        vae = VAE(in_chunk_len=1, **param9)
        vae.fit(self.tsdataset1)
        self.assertIsInstance(vae._network.encoder._nn._nn[1],
        ...
        vae = VAE(in_chunk_len=1, **param10)
        vae.fit(self.tsdataset1)
        ...
        vae = VAE(in_chunk_len=1, **param11)
        vae.fit(self.tsdataset1)
        ...
        vae = VAE(in_chunk_len=1, **param12)
        vae.fit(self.tsdataset1)

    def test_init_dataloader(self):
        """unittest function for init dataloader
        """
        vae = VAE(in_chunk_len=16, max_epochs=1)
    ...
    def test_init_metrics(self):
        ...
        vae = VAE(in_chunk_len=16, max_epochs=1, eval_metrics=["mae"])
    ...
    def test_init_callbacks(self):
        ...
        """
        # case1 (patience = 0)
        vae = VAE(in_chunk_len=16, patience=0)
        ...
        # case2 (patience > 0)
        vae = VAE(in_chunk_len=16, patience=1)
        vae._metrics, vae._metrics_names, _ = vae._init_metrics(["val"])
        ...
        callback = Callback()
        vae = VAE(in_chunk_len=16, callbacks=[callback])
        vae._metrics, vae._metrics_names, _ = vae._init_metrics(["val"])
        _, callback_container = vae._init_callbacks()
