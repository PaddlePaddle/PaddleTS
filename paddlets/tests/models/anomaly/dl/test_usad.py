...
class TestUSAD(TestCase):
    ...
    def test_init(self):
        ...
        usad.fit(self.tsdataset1)
        self.assertIsInstance(usad._network._encoder._nn[1], paddle.nn.BatchNorm1D)
    ...
    def test_init_dataloader(self):
        ...
        _, valid_dataloaders = usad._init_fit_dataloaders(self.tsdataset1, self.tsdataset1)
