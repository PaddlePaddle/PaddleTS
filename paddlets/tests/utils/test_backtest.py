...
class TestBacktest(TestCase):
    ...
    def test_backtest(self):
        ...
        lstnet.fit(self.tsdataset1, self.tsdataset1)
        res = backtest(
            self.tsdataset1, lstnet, start=192, predict_window=50, stride=50)
        assert res != 0
        ...
        with self.assertRaises(ValueError):
            lstnet.fit(self.tsdataset1, self.tsdataset1)
            res = backtest(
                self.tsdataset1, lstnet, stride=-1, return_predicts=True)
        ...
        with self.assertRaises(ValueError):
            lstnet.fit(self.tsdataset1, self.tsdataset1)
            res = backtest(
                self.tsdataset1, lstnet, start=5000, return_predicts=True)
