    ...
    def test_json_pdf_report(self):
        ...
        json = {
            ...
            'summary': {
                'heading': 'SUMMARY',
                'description':
                'Specified statistical indicators, currently support: numbers, mean,                 variance, minimum, 25% median, 50% median, 75% median, maximum value, missing percentage, stationarity p value',
                'analysis_results':
                '{"target":{"missing":0.0,"count":100.0,"mean":1.0,"std":0.0,"min":1.0,"25%":1.0,"50%":1.0,"75%":1.0,"max":1.0},"target2":{"missing":0.0,"count":100.0,"mean":2.0,"std":0.0,"min":2.0,"25%":2.0,"50%":2.0,"75%":2.0,"max":2.0}}'
            }
        }
