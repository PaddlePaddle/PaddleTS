...
class TestWeightingEnsembleAnomly(TestCase):
    ...
    def test_init(self):
        ...
        param = {"sampling_stride": 1, "contamination": 0.2}
        ...
        param = {"sampling_stride": 1, "contamination": 0.2}
        estimators = [(AutoEncoder, ae_param), (AutoEncoder, ae_param)]
        self._model4 = WeightingEnsembleAnomaly(
            1, estimators, standardization=False)

        # case5
        param = {"sampling_stride": 1, "contamination": 0.2}
        estimators = [(AutoEncoder, ae_param)]
        self._model5 = WeightingEnsembleAnomaly(
            1, estimators, contamination=0.2)
